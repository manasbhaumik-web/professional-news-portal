...
export default React.memo(function SkeletonArticleCard({ index }: { key?: React.Key | string | number; index?: number }) {
 ...
 return (
 <div className={`p-5 space-y-3 animate-pulse bg-portal-surface border border-portal-border shadow-sm flex gap-5 ${bentoClass}`}>
 <div className={`shrink-0 bg-portal-bg border border-portal-border/50 ${imageClass}`} />
 <div className="flex-1 space-y-4 py-1">
 <div className="flex justify-between">
 <div className="h-3 w-1/4 bg-portal-bg" />
 <div className="h-3 w-1/6 bg-portal-bg" />
 </div>
 <div className="space-y-2">
 <div className="h-4 w-3/4 bg-portal-bg" />
 <div className="h-4 w-1/2 bg-portal-bg" />
 </div>
 <div className="space-y-2 pt-2">
 <div className="h-2.5 w-full bg-portal-bg" />
 <div className="h-2.5 w-5/6 bg-portal-bg" />
 </div>
 <div className="flex justify-between pt-2">
 <div className="h-2.5 w-1/4 bg-portal-bg" />
 <div className="h-3 w-1/5 bg-portal-bg" />
 </div>
 </div>
 </div>
 );
