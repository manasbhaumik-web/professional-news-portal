...
export default function ReportNewsPage() {
 ...
 {error && (
 <div className="p-4 bg-red-900/20 border border-red-500/30 flex items-start space-x-3 text-red-400">
 ...
 className="w-full bg-portal-surface border border-portal-border px-4 py-3 text-portal-text-main focus:outline-none focus:ring-1 focus:ring-portal-brand focus:border-portal-brand transition-all text-sm font-serif"
 ...
 onChange={handleChange}
 className="w-full bg-portal-surface border border-portal-border px-4 py-3 text-portal-text-main focus:outline-none focus:ring-1 focus:ring-portal-brand transition-all text-sm font-serif appearance-none cursor-pointer"
 >
 ...
 onChange={handleChange}
 className="w-full bg-portal-surface border border-portal-border px-4 py-3 text-portal-text-main focus:outline-none focus:ring-1 focus:ring-portal-brand transition-all text-sm font-serif"
 ...
 onChange={handleChange}
 className="w-full bg-portal-surface border border-portal-border px-4 py-3 text-portal-text-main focus:outline-none focus:ring-1 focus:ring-portal-brand transition-all text-sm font-serif resize-none"
 ...
 <div className="w-full h-40 border-2 border-dashed border-portal-border flex flex-col items-center justify-center text-portal-text-muted bg-portal-surface/50 hover:bg-portal-surface transition-colors group cursor-pointer">
 ...
 onChange={handleChange}
 className="w-full mt-4 bg-portal-surface border border-portal-border px-4 py-3 text-portal-text-main focus:outline-none focus:ring-1 focus:ring-portal-brand transition-all text-sm font-serif"
 placeholder="https://..."
 />
 </div>
 </div>
