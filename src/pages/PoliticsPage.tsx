...
export default function PoliticsPage({ articles, selectedCategoryFromMenu, handleOpenArticle, toggleBookmark, bookmarks, failedImages, setFailedImages, clearFilters, fallbackArticles }: PoliticsPageProps) {
